...
var require_lib3 = __commonJS({
  "node_modules/regex-escape/lib/index.js"(exports, module2) {
    "use strict";
...
var require_pretty_bytes = __commonJS({
  "node_modules/pretty-bytes/index.js"(exports, module2) {
    "use strict";
    var BYTE_UNITS = [
      "B",
      "kB",
...
var formatValue = (value, unit) => {
  ...
  switch (normalizedUnit) {
    ...
    case "byte":
    case "bytes":
      return (0, import_pretty_bytes.default)(value);
    case "kb":
    case "kilobyte":
    case "kilobytes":
      return (0, import_pretty_bytes.default)(value * KILO);
    case "ms":
    case "millisecond":
    case "milliseconds":
...
var createHeadBranchComment = ({ commitSha, metrics, job, previousCommit, title }) => {
...
var getMetricsComment = ({ comments, job }) => {
...
var FLOAT_TO_PERCENT = 100;
var findDeltaComment = (body, job) => {
  const regex = new RegExp(`<!--delta:${(0, import_regex_escape.default)(job)}@(.*)-->`);
...
var readDeltaFiles = async (rootPath) => {
  try {
    ...
    import_core.default.debug(`Could not read delta files: ${error.message}`);
    return [];
  }
};

// src/lib/github.js
var getCommentsFromMainBranch = async ({ commitIndex = 0, octokit, owner, repo }) => {
...
var getInputs = () => {
  const {
    ...
    GITHUB_WORKSPACE: rootPath = import_process.default.cwd()
...
var processPullRequest = async ({ headMetrics, job, octokit, owner, prNumber, repo, title }) => {
  ...
  if (existingDeltaComment) {
    import_core3.default.debug(`Updating existing delta comment: ${existingDeltaComment.url}`);
    ...
    import_core3.default.debug("Creating new delta comment");
...
try {
  ...
  import_core3.default.debug(`Error: ${JSON.stringify(error)}`);
